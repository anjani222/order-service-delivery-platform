pipeline {
  ...
  parameters {
    ...
    string(name: 'ECR_REPOSITORY', defaultValue: 'REPLACE_ACCOUNT.dkr.ecr.us-east-1.amazonaws.com/gitops-platform/order-service', description: 'ECR repository URL')
